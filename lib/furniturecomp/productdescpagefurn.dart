...
class ProductPageFurn extends StatefulWidget {
  @override
  _PFRState createState() => _PFRState();
}

class _PFRState extends State<ProductPageFurn> {
   bool isActive = true;
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/chair1.jpg')))
  );
}
...
Widget Screen2() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/chair2.jpg')),
    ),
  );
}
