...
class _FBState extends State<Beauty> {
  @override
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductPageBeau())),
                    child: Stack(
                    children: <Widget>[
                      Container(
                        color: Colors.white,
                        ...
                        child: Center( child:Text('MakeUp Set \n     Rs.299',style: TextStyle(
                            color: Colors.black,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage('assets/makeup1.jpg'), fit: BoxFit.cover)),
                      ),
                    ...
                    child: Stack(
                      children: <Widget>[
                        Container(
                          ...
                          height: 200,
                          padding: EdgeInsets.only(top: 160,),
                          child: Center( child:Text('MakeUp \n Rs.699',style: TextStyle(
                              color: Colors.black,
                              fontFamily: 'Montserrat',
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/makeup3.jpg'), fit: BoxFit.cover)),
                        ),
