...
class ProductPageBeau extends StatefulWidget {
  @override
  _BState createState() => _BState();
}

class _BState extends State<ProductPageBeau> {
   bool isActive = true;
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/makeup1.jpg'),))
  );
}
...
Widget Screen2() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/makeup3.jpg'),),
    ),
  );
}
...
Widget Screen3() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/makeup2.jpg')),
    ),
  );
}
