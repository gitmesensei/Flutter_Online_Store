...
class ProductPageApl extends StatefulWidget {
  @override
  _BaplState createState() => _BaplState();
}

class _BaplState extends State<ProductPageApl> {
   bool isActive = true;
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/app2.png'), fit: BoxFit.fill,))
  );
}
...
Widget Screen2() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/app3.jpg')),
    ),
  );
}
...
Widget Screen3() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/app4.jpg'),),
    ),
  );
}
