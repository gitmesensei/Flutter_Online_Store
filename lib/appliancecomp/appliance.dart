...
class Appliance extends StatefulWidget {
  @override
  _AplState createState() => _AplState();
}

class _AplState extends State<Appliance> {
  @override
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductPageApl())),
                    child: Stack(
                    children: <Widget>[
                      Container(
                        color: Colors.white,
                        ...
                        child: Center( child:Text('Huawei Black Phone \n             \$299',style: TextStyle(
                            color: Colors.black,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage('assets/app2.png'), fit: BoxFit.cover)),
                      ),
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/app3.jpg'), fit: BoxFit.cover)),
                        ),
