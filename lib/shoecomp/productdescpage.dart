...
class _PState extends State<ProductPage> {
   bool isActive = true;
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Text('black & white casual shoes',
                          style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 12.0,
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/shoe1.jpg'), fit: BoxFit.fill,))
  );
}
...
Widget Screen2() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/shoe3.jpg'), fit: BoxFit.fill),
    ),
  );
}
...
Widget Screen3() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/shoe2.jpg'), fit: BoxFit.fill),
    ),
  );
}
...
Widget Screen4() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/shoe4.jpg'), fit: BoxFit.fill),
    ),
  );
}
