...
import 'package:onlinestore/shoecomp/productdescpage.dart';
...
class _ShState extends State<Shoes> {
  @override
                  ...
                  InkWell(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Center( child:Text('Adidas Shoes \n    Rs.299',style: TextStyle(
                            color: Colors.black,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage('assets/adidas.jpg'), fit: BoxFit.cover)),
                      ),
                    ...
                    child: Stack(
                      children: <Widget>[
                        Container(
                          ...
                          height: 200,
                          padding: EdgeInsets.only(top: 160,),
                          child: Center( child:Text('Jordan Shoes \n      Rs.699',style: TextStyle(
                              color: Colors.black,
                              fontFamily: 'Montserrat',
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/jordan.jpg'), fit: BoxFit.cover)),
                        ),
