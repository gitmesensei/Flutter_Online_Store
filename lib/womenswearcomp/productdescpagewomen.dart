...
class ProductPageWo extends StatefulWidget {
  @override
  _PwState createState() => _PwState();
}

class _PwState extends State<ProductPageWo> {
   bool isActive = true;
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text('Adidas Jacket and Top',
                  style: TextStyle(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Text('black & white casual jacket',
                          style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 12.0,
...
Widget Screen3() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/women3.jpg')),
    ),
  );
}
