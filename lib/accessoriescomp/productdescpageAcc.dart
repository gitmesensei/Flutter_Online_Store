...
class ProductPageAcc extends StatefulWidget {
  @override
  _BaccState createState() => _BaccState();
}

class _BaccState extends State<ProductPageAcc> {
   bool isActive = true;
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text('Colourful Bangles and Bag Combo',
                  style: TextStyle(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Text('colourful set of accessories',
                          style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 12.0,
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/access2.jpg'), ))
  );
}
...
Widget Screen2() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/access3.jpg'),),
    ),
  );
}
...
Widget Screen3() {
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
          image: AssetImage('assets/access1.jpg'),),
    ),
  );
}
